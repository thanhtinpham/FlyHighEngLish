...
<section class="py-10 bg-slate-50 border-b border-slate-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-2xl mx-auto mb-8 space-y-1">
            <span class="text-xs font-bold text-blue-600 uppercase tracking-wider">Cảm Nhận Học Viên</span>
            <h2 class="text-2xl font-extrabold text-slate-900 font-heading">Học Viên Nói Gì Về Fly High English?</h2>
            <p class="text-xs text-slate-600">Kết quả thực tế từ sự nỗ lực của học viên và sự đồng hành của trung tâm</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            
            <div class="p-5 rounded-xl bg-white border border-slate-200 space-y-3">
                <div class="flex items-center justify-between">
                    ...
                    <span class="px-2 py-0.5 bg-blue-50 text-blue-700 text-xs font-bold rounded border border-blue-200">Đạt B1 VSTEP</span>
                </div>
                ...
                <div class="flex items-center gap-3 pt-2 border-t border-slate-100">
                    ...
                    <div>
                        ...
                        <span class="text-[10px] text-slate-400 block">Học viên tháng 5/2026</span>
                    </div>
                </div>
            </div>
            ...
            <div class="p-5 rounded-xl bg-white border border-slate-200 space-y-3">
                <div class="flex items-center justify-between">
                    ...
                    <span class="px-2 py-0.5 bg-blue-50 text-blue-700 text-xs font-bold rounded border border-blue-200">IELTS 7.5</span>
                </div>
                <p class="text-xs text-slate-600 leading-relaxed italic">
            ...
            <div class="p-5 rounded-xl bg-white border border-slate-200 space-y-3">
                <div class="flex items-center justify-between">
                    ...
                    <span class="px-2 py-0.5 bg-blue-50 text-blue-700 text-xs font-bold rounded border border-blue-200">Giao Tiếp</span>
                </div>
                <p class="text-xs text-slate-600 leading-relaxed italic">
