...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-xl p-8 sm:p-10 space-y-6">
        <div>
            ...
            <p class="text-sm text-slate-500">Đổi tên hiển thị tài liệu hoặc thay thế tệp tin hiện tại</p>
        </div>
        ...
        <form action="{{ route('admin.documents.update', $document) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                <label for="title" class="block text-sm font-bold text-slate-700 mb-1">Tên tiêu đề hiển thị <span class="text-rose-500">*</span></label>
            ...
            <div>
                <label for="file" class="block text-sm font-bold text-slate-700 mb-1">Thay thế tệp tin khác (Không bắt buộc)</label>
