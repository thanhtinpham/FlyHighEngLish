...
@section('title', 'Thêm Bài Học - Admin Fly High English')
...
<section class="bg-slate-900 text-white py-10">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 class="text-2xl font-black">Thêm / Upload Bài Học Mới</h1>
    </div>
</section>
...
<section class="py-12 bg-slate-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <form action="{{ route('admin.lessons.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
            ...
            <!-- Upload file for student download -->
            <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
                <h3 class="font-extrabold text-slate-900 text-sm">Tệp Bài Học Đính Kèm (Học viên tải về)</h3>
                
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-1">Tải lên file bài học (HTML, PDF, ZIP...)</label>
